"""
Run 2: Markdown-aware chunking with SEMANTIC relevance evaluation.
"""
import sys
import time
...
def run():
    print("=" * 50)
    print("Run 2: Markdown-Aware + Semantic Evaluation")
    print("=" * 50)
    ...
    index_chunks(chunks, embeddings, strategy="markdown_v2")
    ...
    for q in golden:
        results = vector_search(q["question"], top_k=5, strategy_filter="markdown_v2")
    ...
    result = ExperimentResult(
        ...
        config={"max_chunk_size": 1024, "evaluation": "semantic", "threshold": 0.6},
    ...
    delete_all_documents(strategy_filter="markdown_v2")
