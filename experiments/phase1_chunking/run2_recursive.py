"""
Run 2: Recursive chunking with SEMANTIC relevance evaluation.
"""
import sys
import time
...
def run():
    print("=" * 50)
    print("Run 2: Recursive + Semantic Evaluation")
    print("=" * 50)
    ...
    index_chunks(chunks, embeddings, strategy="recursive_v2")
    ...
    for q in golden:
        results = vector_search(q["question"], top_k=5, strategy_filter="recursive_v2")
    ...
    delete_all_documents(strategy_filter="recursive_v2")
