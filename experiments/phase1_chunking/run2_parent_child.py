"""
Run 2: Parent-child chunking with SEMANTIC relevance evaluation.
"""
import sys
import time
...
def run():
    print("=" * 50)
    print("Run 2: Parent-Child + Semantic Evaluation")
    print("=" * 50)
    ...
    index_chunks(chunks, embeddings, strategy="parent_v2")
    ...
    for q in golden:
        results = vector_search(q["question"], top_k=5, strategy_filter="parent_v2")
    ...
    result = ExperimentResult(
        ...
        config={"parent_size": 1024, "child_size": 256, "child_overlap": 30, "evaluation": "semantic", "threshold": 0.6},
    ...
    delete_all_documents(strategy_filter="parent_v2")
